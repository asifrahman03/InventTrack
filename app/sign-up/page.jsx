  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res) {
        ...
        // Create an initial document in the user's pantry collection
        await setDoc(doc(firestore, `inventory-${userId}`, 'initial'), {
          initialized: true
        });
    ...
    return (
      <div className="min-h-screen bg-blue-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md w-96 text-center">
          ...
          <p>Thank you for signing up. You can now sign in. {router.push('/sign-in')}</p>
        </div>
      </div>
    );
  }
...
//         // Create a new collection for the user's pantry
//         await setDoc(doc(firestore, `inventory-${userId}`, 'initial'), {
//           createdAt: new Date(),
//         });
...
//         <div className="bg-white p-8 rounded-lg shadow-md w-96 text-center">
//           <h2 className="text-2xl font-semibold mb-4">Sign Up Successful!</h2>
//           <p>Thank you for signing up. You can now <Link href="/sign-in" className="text-blue-600 hover:text-blue-800 transition duration-200">sign in</Link>.</p>
//         </div>
